...
class HomePageLargeTablet extends StatefulWidget {
  const HomePageLargeTablet({super.key});

  @override
  State<HomePageLargeTablet> createState() => _HomePageLargeTabletState();
}

class _HomePageLargeTabletState extends State<HomePageLargeTablet> {
